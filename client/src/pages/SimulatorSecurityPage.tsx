...
import { Shield, ArrowLeft, ExternalLink, ShieldHalf } from "lucide-react";
import { Link } from "wouter";

export function SimulatorSecurityPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="flex-1 px-4 pb-6 sm:px-6">
          <iframe
            src="/seguranca/index.html"
            title="Simulador de Segurança da SF Cyber"
