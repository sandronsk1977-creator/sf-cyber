...
const CONTACTS = [
  ...
  {
    label: "WhatsApp",
    href: "https://api.whatsapp.com/send/?phone=5562999693469&text=Ol%C3%A1%2C%20vim%20atrav%C3%A9s%20da%20p%C3%A1gina%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20a%20SF%20Cyber.",
    icon: WhatsAppIcon,
  },
];
...
export function ContactRail() {
  return (
    <div className="fixed right-4 md:right-5 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center gap-3">
